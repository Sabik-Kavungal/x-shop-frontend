...
class _$ItemModelImpl implements _ItemModel {
  ...
  @override
  String toString() {
    return 'ItemModel(id: $id, name: $name, price: $price, description: $description, image: $image, categoryId: $categoryId, categoryName: $categoryName)';
  }
